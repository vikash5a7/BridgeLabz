...
public class Implementation {
	...
	static String filename = "stock.json";
	...
	public void addDetails() {
		...
		UtilForAddressBook.writeData(filename, jArray);
		jArray = UtilityClinic.readData(filename);
	}

	public void displayData() {
		System.out.println("--------Details----------");
		System.out.println("Name \t Share \t Price \t Value");
		JSONArray readData = UtilForAddressBook.readData(filename);
		double value = 0.0;

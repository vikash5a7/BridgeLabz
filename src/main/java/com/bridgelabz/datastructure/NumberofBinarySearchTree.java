...
public class NumberofBinarySearchTree {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter how a number to find number of BST: ");
		int num = Utility.inputNumber();
		System.out.println("Total number of possible Binary Search Trees with given key: " + bt.numOfBST(num));
	}
}